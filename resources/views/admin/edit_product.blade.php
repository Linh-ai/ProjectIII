                                    ...
                                    <form class="theme-form theme-form-2 mega-form" method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="number" step="0.01" placeholder="Price" name="price" value="{{$product->price}}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="number" placeholder="Quantity" name="quantity" value="{{$product->quantity}}" >
                                                </div>
                                            </div>
