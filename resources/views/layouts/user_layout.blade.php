                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            <div class="brand-logo">
                                ...
                                {{--                            Phan logo xoay + ten web o ben trai--}}
                                <a href="{{route('home')}}">
                                    <svg class="svg-icon">
                        ...
                        {{--                    Phan 3 dau gach ngang, bam vao mo ra slide ben phai--}}
                        <nav>
                            <div class="main-navbar">
                                <div id="mainnav">
                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        {{--                                        Bam vao tro ve trang home--}}
                                        <li class="mega-menu home-menu">
                                            <a href="{{route('home')}}" class="nav-link menu-title gradient-title">home</a>
                                        </li>
                                        {{--                                        Bam vao chuyen toi trang liet ke san pham--}}
                                        <li>
                                            <a href="" class="nav-link menu-title gradient-title">shop</a>
                                        </li>
                                        {{--                                        Giao dien add to mobile--}}
                        ...
                        {{--                    Phan tim kiem + ten nguoi dung + wishlist o ben phai--}}
                        <div class="menu-right"  >
                            <ul >
                                ...
                                {{--                            Neu da dang nhap thi hien ten va logout, khong thi hien dang nhap va dang ki--}}
                                    ...
                                    <div class="onhover-div frontpricecard"  >
                                        ...
                                        <div class="cart-menu">
                                            <div class="cart-title">
                                                {{--                                            HIEN THI SO LUONG SAN PHAM TRONG CART TREN GOC TREN BEN PHAI LOGO--}}
                                                <h6>
                                                    <i data-feather="shopping-bag"></i>
                                                    <span class="label label-theme rounded-pill"></span>
                                                </h6>
                                                {{--                                            MUI TEN THU HOI SLIDE--}}
                                        ...
                                        {{--                                    HIEN THI TONG SO TIEN (GIA) VA NUT BAM CHUYEN VE GIAO DIEN SHOW CART--}}
                                        <div class="cart-btn">
...
<footer class="footer-sm-space">
    {{--HIEN THI PHAN THONG TIN TRANG WEB--}}
    <div class="main-footer">
        <div class="container">
            <div class="row gy-4">
                {{--            HIEN THI SO DIEN THOAI, DIA CHI, EMAIL--}}
                        ...
                        @if(! isset($user))
                            ...
                            <form
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    {{--                                CHUYEN HUONG TOI TRANG DANG KI--}}
                                    <span class="input-group-text" id="basic-addon4"><a href=""><i class="fas fa-arrow-right"></i></a></span>
                                </div>
                ...
                <div class="modal-contain">
                    <div>
                        <div class="modal-messages">
                            <i class="fas fa-check"></i> 3-stripes full-zip hoodie successfully added to you cart.
                        </div>
