...
@section('content')
    ...
    {{--PHAN 2 ANH CHUYEN DONG SIZE TO--}}
    <!-- home slider start -->
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-12 ratio_40">
                            <div class="collection-banner p-left banner-title">
                                <a href="shop-left-sidebar.html" class="banner-img">
                                    <img src="{{asset('voxo_front/assets/images/fashion/banner/5.jpg')}}" class="bg-img blur-up lazyload" alt="">
                                </a>
                                <div class="banner-text">
                                    <div class="banner-content">
