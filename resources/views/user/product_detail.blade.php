...
@section('content')
    {{--PHAN GIAO DIEN CAC HINH VUONG XOAY QUANH--}}
    ...
    <section>
        <div class="container">
            <div class="row gx-4 gy-5">
                <div class="col-12">
                    {{--            PHAN ANH + TEN SP + ADD TO CART--}}
                    <div class="details-items">
                        <div class="row g-4">
                            <div class="col-md-6">
                                {{--                        PHAN ANH CHINH O TREN + ANH CHAY O DUOI--}}
                                <div class="degree-section">
                                    {{--                            PHAN ANH CHINH O TREN--}}
                                ...
                                <div class="cloth-details-size">
                                    ...
                                    <div id="selectSize" class="addeffect-section product-description border-product">
                                        ...
                                        <div id="selectSize" class="addeffect-section product-description border-product">
                                            ...
                                            <div class="qty-box">
                                                ...
                                                <button type="button" class="btn quantity-left-minus"
                                                    ...
                                                    {{--                                        PHAN NHAP SO LUONG--}}
                                                    <input type="number" name="quantity" class="form-control input-number pr_quantity"  value="1" min="1" max="{{$product->product_quantity}}">
                                                    {{--                                        PHAN CONG SO LUONG SP--}}
                                                    <span class="input-group-prepend">
                                        ...
                                        <div class="product-buttons">
                                            {{--                                NEU DA DANG NHAP, HIEN THI NUT WISHLIST, KHI BAM VAO THI KHOI DONG THEM VAO WISHLIST--}}

                                            {{--                                NEU DA DANG NHAP KHI BAM VAO GOI HAM ADD CART, NEU KO CHUYEN TOI TRANG DANG NHAP--}}
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="desc">
                                    <div class="shipping-chart">
                                        <div class="part">
                                            <h4 class="inner-title mb-2">Give you a complete views about product</h4>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="review-box">
                                                <form class="row g-4">
                                                    ...
                                                    <div class="col-12">
                                                        {{--                                            NUT BAM GUI TOI GOI TOI HAM ADD COMMENT--}}
                                                        <button type="submit"
                                                                class="btn default-light-theme default-theme default-theme-2" onclick="">Submit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>

                                        {{--                            PHAN LIET KE CAC COMMENT--}}
